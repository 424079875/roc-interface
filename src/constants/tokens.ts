...
export const rocUSDT = new Token(ChainId.ROC, '0xf4b318503fbB16FA5641c54f6fDE781F5dbbFBfD', 18, 'usdt', 'usdt test')
export const rocSOL = new Token(ChainId.ROC, '0xd1952B06Db5DD8562bA8B35882fd460CEB136BE7', 18, 'sol', 'sol')
...
export const UNI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.ROC]: new Token(ChainId.ROC, UNI_ADDRESS[ChainId.ROC], 18, 'UNI', 'Uniswap'),
}
