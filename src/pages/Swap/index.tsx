...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const priceImpactTooHigh = priceImpactSeverity > 5 && !isExpertMode
  console.log('priceImpactTooHigh',priceImpactSeverity)
  return (
    <>
      <TokenWarningModal
            ...
            <BottomGrouping>
              {swapIsUnsupported ? (
                ...
                <AutoRow style={{ flexWrap: 'nowrap', width: '100%' }}>
                  <AutoColumn style={{ width: '100%' }} gap="12px">
                    ...
                    <ButtonError
                      ...
                      error={isValid && priceImpactSeverity > 4}
                    >
                      <Text fontSize={16} fontWeight={500}>
                        {priceImpactTooHigh ? `High Price Impact` : `Swap${priceImpactSeverity > 4 ? ' Anyway' : ''}`}
                      </Text>
                    </ButtonError>
                  </AutoColumn>
                </AutoRow>
                ...
                <ButtonError
                  ...
                  error={isValid && priceImpactSeverity > 4 && !swapCallbackError}
                >
                  <Text fontSize={20} fontWeight={500}>
                    {swapInputError
                      ...
                      : `Swap${priceImpactSeverity > 4 ? ' Anyway' : ''}`}
                  </Text>
                </ButtonError>
              )}
